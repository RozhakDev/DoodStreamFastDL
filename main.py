...
from doodstreamfastdl.core.downloader import DoodStreamFastDL
from doodstreamfastdl.utils.helper import setup_logger
...
async def main():
    """Fungsi utama untuk menjalankan DoodStreamFastDL CLI.
    ...
    parser = argparse.ArgumentParser(
        description="DoodStreamFastDL CLI - Alat Pengunduh Video dari DoodStream.",
