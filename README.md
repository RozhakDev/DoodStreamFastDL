# DoodStreamFastDL - Pengunduh Video DoodStream Cepat & Bersih via Command-Line.

![DoodStreamFastDL Logo](https://github.com/user-attachments/assets/435bcd25-14c9-47c3-b3d6-28dab6070d92)
<p align="left">
...
**DoodStreamFastDL** adalah sebuah _command-line interface_ (CLI) tool yang dirancang untuk memberikan pengalaman terbaik dalam mengunduh video dari DoodStream. Proyek ini merupakan evolusi dari [DoodStreamFastDL (versi web)]() yang diadaptasi untuk kemudahan penggunaan di terminal, terutama bagi pengguna di lingkungan seperti Termux di Android.
...
Berikut adalah contoh bagaimana DoodStreamFastDL bekerja di terminal.
...
2025-08-26 17:39:24 [INFO] - Video akan disimpan di: /mnt/c/DoodStreamFastDL/Night Skyline Manila - DoodStream.mp4
...
DoodStreamFastDL - Alat Pengunduh Video dari DoodStream.
...
2. **Kloning Repositori**
   ...
   ```bash
   git clone https://github.com/RozhakDev/DoodStreamFastDL.git
   cd DoodStreamFastDL
   ```
...
Setelah langkah-langkah ini selesai, DoodStreamFastDL siap digunakan!
